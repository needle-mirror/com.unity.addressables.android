...
If your application uses [Texture Compression Targeting](https://docs.unity3d.com/Manual/android-distribution-google-play.html#texture-compression-targeting), then the same Android **Texture Compression Formats** settings is applied when you build
...
>[!NOTE]
>[Texture Compression Targeting](https://docs.unity3d.com/Manual/android-distribution-google-play.html#texture-compression-targeting) works only when building Android App Bundles (AAB) or Gradle project for AAB. When building an APK (or Gradle project for APK) only default texture compression is used.
